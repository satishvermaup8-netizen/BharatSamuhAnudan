...
export const mockGroups: Group[] = [
  ...
  {
    id: '4',
    name: 'Kolkata Community Fund',
    description: 'Empowering Kolkata residents through community savings and mutual support.',
    groupCode: 'KCF5M7X3',
    photo: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=400&fit=crop',
    leaderId: '3',
    leaderName: 'Anjali Dey',
    memberCount: 320,
    maxMembers: 1000,
    totalFund: 1024000,
    status: 'active',
  ...
  {
    id: '5',
    name: 'Chennai Prosperity Circle',
    description: 'Chennai-based group dedicated to financial growth and collective prosperity.',
    groupCode: 'CPC9K2L8',
    photo: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=400&fit=crop',
    leaderId: '4',
  ...
  {
    id: '6',
    name: 'Pune Savers Network',
    description: 'A dynamic savings group connecting Pune professionals for financial security.',
    groupCode: 'PSN4P6Q9',
    photo: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=400&fit=crop',
    leaderId: '2',
    leaderName: 'Priya Sharma',
  ...
  {
    id: '7',
    name: 'Hyderabad Women Cooperative',
    description: 'Empowering women through collaborative savings and mutual assistance.',
    groupCode: 'HWC2N8O5',
    photo: 'https://images.unsplash.com/photo-1552664730-d307ca884978?w=400&h=400&fit=crop',
    leaderId: '5',
    leaderName: 'Deepa Sharma',
    memberCount: 380,
    maxMembers: 1000,
    totalFund: 1216000,
    status: 'active',
